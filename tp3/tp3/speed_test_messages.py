...
def add_chat_messages(messages):
    ...
    keywords_array.append(RiskWord.objects.create(suite=suite_obj, keyword="today", risk_factor=10))
    keywords_array.append(RiskWord.objects.create(suite=suite_obj, keyword="weekend", risk_factor=10))
    keywords_array.append(RiskWord.objects.create(suite=suite_obj, keyword="weather", risk_factor=10))
    keywords_array.append(RiskWord.objects.create(suite=suite_obj, keyword="Autumn", risk_factor=10))
    keywords_array.append(RiskWord.objects.create(suite=suite_obj, keyword="book", risk_factor=10))
    keywords_array.append(RiskWord.objects.create(suite=suite_obj, keyword="episode", risk_factor=10))
    keywords_array.append(RiskWord.objects.create(suite=suite_obj, keyword="holidays", risk_factor=10))
    keywords_array.append(RiskWord.objects.create(suite=suite_obj, keyword="situation", risk_factor=10))
